...
class Contato(models.Model):
	...
	contato_sexo = models.CharField(max_length=45, choices = SEXO_CHOICES)
	contato_estado_civil = models.CharField(max_length=45, choices=ESTADO_CIVIL_CHOICES, verbose_name='Estado Civil')
